    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          ...
          >
            <Image alt="SSBS" src="/econ.svg" width="50" height="3" />
          </motion.div>
          <nav className="hidden gap-6 md:flex">
            {["About", "Team", "Events", "Resources"].map((item, i) => (
              ...
              >
                ...
                >
                  {item}
                  <span className="absolute -bottom-1 left-0 h-0.5 w-0 bg-gradient-to-r from-emerald-600 to-emerald-800 transition-all group-hover:w-full"></span>
                </Link>
              </motion.div>
            ))}
          </nav>
      ...
      <main className="flex-1">
              ...
              <div className="flex h-full w-full flex-col items-center justify-center gap-8 p-8">
                <BlurFadeStagger initialDelay={0.1}>
                  <div className="flex flex-col items-center gap-4">
                    <h1 className="w-full bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 bg-clip-text text-center text-6xl font-bold tracking-tight text-transparent sm:text-7xl md:text-8xl">
                      TOKENS
                      <br />
                      Economics Club
                    </h1>
        ...
        <section id="about" className="relative w-full overflow-hidden py-24">
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-emerald-50 to-white"></div>
          ...
          >
            <div className="mb-12 flex flex-col items-center justify-center space-y-4 text-center">
              <div className="mb-2 inline-block rounded-full bg-emerald-100 px-3 py-1 text-sm font-semibold text-emerald-800">
                About Us
              </div>
            ...
            <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
              {[
                {
                  icon: <BookOpen className="h-10 w-10 text-emerald-700" />,
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group flex flex-col items-center rounded-xl border border-zinc-100 bg-white p-6 shadow-lg transition-all duration-300 hover:border-emerald-200 hover:shadow-xl"
                >
                  <div className="mb-4 rounded-full bg-emerald-50 p-4 transition-colors duration-300 group-hover:bg-emerald-100">
                    {item.icon}
                  </div>
        ...
        <section id="team" className="w-full bg-zinc-900 py-24 text-white">
          <div className="container px-4 md:px-6">
            ...
            >
              <div className="mb-2 inline-block rounded-full bg-emerald-900/30 px-3 py-1 text-sm font-semibold text-emerald-400">
                Our Team
              </div>
              <h2 className="bg-gradient-to-br from-emerald-300 to-emerald-500 bg-clip-text text-3xl font-bold tracking-tighter text-transparent sm:text-4xl md:text-5xl">
                Meet Our Leaders
              </h2>
            ...
            <div className="mt-12 grid grid-cols-1 gap-12 md:grid-cols-2">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group flex flex-col items-center gap-6 rounded-xl border border-zinc-700 bg-zinc-800/50 p-6 transition-all duration-300 hover:border-emerald-700 md:flex-row"
                >
                  <div className="flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-br from-emerald-600 to-emerald-800 text-4xl font-bold text-white">
                    {member.name.charAt(0)}
                  </div>
                  <div className="flex flex-col text-center md:text-left">
                    <h3 className="text-2xl font-bold transition-colors duration-300 group-hover:text-emerald-400">
                      {member.name}
                    </h3>
              ...
              {[
                ...
                >
                  <Link href={resource.link} className="block h-full">
                    <div className="group flex h-full flex-col rounded-xl border border-zinc-700 bg-zinc-800 p-6 transition-all duration-300 hover:border-emerald-600 hover:shadow-[0_0_15px_rgba(16,185,129,0.15)]">
                      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-zinc-700/50 p-4 text-emerald-400 transition-colors duration-300 group-hover:bg-zinc-700 group-hover:text-emerald-300">
                        {resource.icon}
                      </div>
                      <h3 className="mb-2 text-xl font-bold transition-colors duration-300 group-hover:text-emerald-400">
                        {resource.title}
                      </h3>
      ...
      <footer className="w-full border-t bg-zinc-950 py-12">
        <div className="container flex flex-col items-center justify-center gap-6">
          <div className="flex flex-col items-center gap-2">
            <h2 className="bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-2xl font-bold tracking-tight text-transparent">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-zinc-900 p-2 text-zinc-400 transition-colors duration-300 hover:bg-zinc-800 hover:text-emerald-400"
            >
