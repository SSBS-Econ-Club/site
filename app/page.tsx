          ...
          >
            <div className="mb-12 flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[700px] text-zinc-600 md:text-xl">
                We provide comprehensive support for AP Microeconomics, AP
                Macroeconomics, and prepare students for the National Economics
                Challenge (NEC).
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Master the principles of individual decision-making, market behavior, and firm strategy.",
                },
                {
                  icon: <TrendingUp className="h-10 w-10 text-amber-500" />,
                  title: "AP Macroeconomics",
                  description:
                    "Understand national income, price determination, economic growth, and international economics.",
                },
                {
                  icon: <Users className="h-10 w-10 text-amber-500" />,
                  title: "NEC Competition",
                  description:
                    "Compete in the National Economics Challenge and showcase your economic knowledge.",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
